# Wallpaper
wallpaper='/usr/share/backgrounds/walls/astronaut.jpg'

# Terminal
wal -i /usr/share/backgrounds/walls/astronaut.jpg
...
# Appearance
xfwm_theme='Rosepine-B'
gtk_font='Noto Sans 13'
gtk_theme='Rosepine-B'
icon_theme='neo-candy-vertexed'
